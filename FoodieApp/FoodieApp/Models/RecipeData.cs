...
namespace FoodieApp
{
   ...
   {
       public static List<Recipe> _allRecipes;

        #region Get data from Recipe
        ...
        #region Get data from group   
       //public static List<RecipeGroups> AllRecipesGrouped
       //{
       //    get
       //    {
       //        if (_allRecipesGrouped == null)
       //        {
       //            var easyGrouping = new RecipeGroups("Easy", "E");
       //            easyGrouping.AddRange(RecipeData.GetAllRecipe.Where(r => r.Difficulty == Difficulty.Easy));

       //            var mediumGrouping = new RecipeGroups("Medium", "M");
       //            mediumGrouping.AddRange(RecipeData.GetAllRecipe.Where(r => r.Difficulty == Difficulty.Medium));

       //            var hardGrouping = new RecipeGroups("Hard", "H");
       //            hardGrouping.AddRange(RecipeData.GetAllRecipe.Where(r => r.Difficulty == Difficulty.Hard));

       //            _allRecipesGrouped = new List<RecipeGroups> {
       //                easyGrouping,
       //                mediumGrouping,
       //                hardGrouping
       //            };
       ...
       public static ObservableCollection<ListViewGrouping<Recipe>> AllRecipesGrouped
       {
           get
           {
               if (_allRecipesGrouped == null)
               {
                   ...
                   easyGrouping.AddRangee(RecipeData.GetAllRecipe.Where(r => r.Difficulty == Difficulty.Easy));
                   
                   var mediumGrouping = new ListViewGrouping<Recipe>("Medium", "M");
                   mediumGrouping.AddRangee(RecipeData.GetAllRecipe.Where(r => r.Difficulty == Difficulty.Medium));

                   var hardGrouping = new ListViewGrouping<Recipe>("Hard", "H");
                   hardGrouping.AddRangee(RecipeData.GetAllRecipe.Where(r => r.Difficulty == Difficulty.Hard));
       ...
       public static Recipe SingleRecipe
       {
           get
           {
               return GetAllRecipe.ElementAt(0);
           }
       }
        #endregion
    }
